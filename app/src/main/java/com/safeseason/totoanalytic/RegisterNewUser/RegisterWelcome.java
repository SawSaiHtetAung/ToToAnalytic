 ...
 * Use the {@link RegisterWelcome#newInstance} factory method to
...
public class RegisterWelcome extends Fragment {
     ...
     * @return A new instance of fragment RegisterWelcome.
     */
    // TODO: Rename and change types and number of parameters
    public static RegisterWelcome newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CheckBox agreement = view.findViewById(R.id.regWelcomeAgreement);
        agreement.setOnCheckedChangeListener((compoundButton, flag) -> viewModel.userAgreementChk(flag));
